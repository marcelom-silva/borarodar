...
export var translations = {
  pt: {
    ...
    profile_family_baby:'Familia+Bebe', profile_family_senior:'Com Idosos', profile_friends:'Grupo',

    // Veiculo — incluindo strings do VehicleSelect
    ...
    seasonal_junefest:'Festas Juninas: epoca perfeita para o Nordeste! Sao Joao em Campina Grande e Caruaru.',
    ...
    // Roteiro / IA — incluindo labels do DayItinerary
  ...
  en: {
    ...
    profile_family_baby:'Family+Baby', profile_family_senior:'With Seniors', profile_friends:'Group',
    ...
    seasonal_summer:'Summer: intense heat. Bring lots of water, SPF50+ sunscreen and insect repellent.',
    seasonal_winter:'Winter: cold in the South and mountains. Bring warm clothes for mornings and nights.',
    ...
    seasonal_carnival:'Carnival period: heavy road traffic. Book accommodation well in advance.',
    seasonal_easter:'Holy Week: historic destinations at high occupancy. Book in advance.',
    seasonal_junefest:'Junina Festivals: great time for Northeast Brazil! Sao Joao in Campina Grande and Caruaru.',
    seasonal_adventure:'Adventure: bring non-slip footwear, quick-dry clothing and DEET 20%+ repellent.',
    seasonal_beach:'Beach: SPF50+ sunscreen, UV clothing, hat. Avoid sun between 10am and 4pm.',
  ...
  es: {
    ...
    profile_family_baby:'Familia+Bebe', profile_family_senior:'Con Mayores', profile_friends:'Grupo',
    ...
    seasonal_summer:'Verano: calor intenso. Lleva mucha agua, protector solar FPS50+ y repelente.',
    seasonal_winter:'Invierno: frio en el Sur y la Sierra. Lleva ropa abrigada para mananas y noches.',
    seasonal_mild:'Clima agradable para viajar — dias templados y noches frescas.',
    seasonal_rainy:'Temporada de lluvias (nov-abr): cuidado con inundaciones y deslizamientos en rutas serranas.',
    seasonal_carnival:'Periodo de Carnaval: intenso trafico en las rutas. Reserva alojamiento con anticipacion.',
    seasonal_easter:'Semana Santa: destinos historicos con alta ocupacion. Reserva con anticipacion.',
    seasonal_junefest:'Fiestas Juninas: epoca perfecta para el noreste de Brasil.',
    seasonal_adventure:'Aventura: lleva calzado antideslizante, ropa de secado rapido y repelente DEET 20%+.',
    seasonal_beach:'Playa: protector solar FPS50+, ropa UV, sombrero. Evita el sol entre las 10h y 16h.',
    seasonal_nature:'Senderos: lleva linterna, botiquin de primeros auxilios y mucha agua.',
