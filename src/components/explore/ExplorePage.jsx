...
var THEMATIC = [
  ...
  { icon:Landmark, color:'#39FF14', title:'Rota Colonial MG',     desc:'Ouro Preto, Tiradentes, Mariana. Arte barroca e historia da Inconfidencia.',                    tag:'Historia',    km:'420 km' },
  { icon:Trees,    color:'#39FF14', title:'Transpantaneira',      desc:'A estrada mais selvagem do Brasil. Jacarés, capivaras e tuiuius no Pantanal.',                  tag:'Aventura',    km:'148 km' },
  { icon:Sun,      color:'#FF6B35', title:'Rota do Sol (RN-CE)',  desc:'Natal, Pipa, Canoa Quebrada, Jericoacoara. Dunas, lagoas e falesias laranja.',                  tag:'Praia',       km:'530 km' },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-16">
      ...
      <div className="flex gap-2 mb-8 border-b border-white/5">
        {[{ k:'rotas', l:t('explore_routes') }, { k:'destinos', l:t('explore_dest') }].map(function({ k, l }) {
          return (
